...
;// ./src/components/StadiumBackground.tsx



const StadiumBackground = () => {
  const frame = (0,esm.useCurrentFrame)();
  const lightPulse = (0,esm.interpolate)(
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ...
      {
        style: {
          background: "linear-gradient(180deg, transparent 55%, rgba(0,40,15,0.55) 75%, rgba(0,60,20,0.80) 100%)"
        }
      }
    ),
    [...Array(6)].map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          ...
          right: 0,
          height: `${(i + 1) * 9}%`,
          background: i % 2 === 0 ? "rgba(0,80,20,0.10)" : "rgba(0,50,10,0.06)",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ...
      {
        style: {
          background: "radial-gradient(ellipse 40% 60% at -5% 40%, rgba(0,100,255,0.07) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ...
      {
        style: {
          background: "radial-gradient(ellipse 40% 60% at 105% 40%, rgba(0,180,80,0.06) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          right: "10%",
          height: 2,
          background: "linear-gradient(90deg, transparent, rgba(255,255,255,0.12) 20%, rgba(255,255,255,0.20) 50%, rgba(255,255,255,0.12) 80%, transparent)",
          borderRadius: 2
        }
      }
    ),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ...
      {
        style: {
          background: "radial-gradient(ellipse 85% 85% at 50% 50%, transparent 40%, rgba(0,0,0,0.65) 100%)"
        }
      }
    )
  ] });
...
;// ./src/components/FlagPlaceholder.tsx
...
const FlagPlaceholder = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        stripes.map((color, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              flex: 1,
        ...
        symbol && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
...
const VoteBar = ({
  ...
  const numOpacity = (0,esm.interpolate)(frame - startFrame, [0, 12], [0, 1], {
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
...
const GoldDivider = ({
  ...
  "div",
  {
    style: {
      width,
      height: 1,
      background: "linear-gradient(90deg, transparent, #b8972a 20%, #f0c040 50%, #b8972a 80%, transparent)",
      opacity,
      margin: "0 auto"
    }
  }
...
;// ./src/compositions/VozDoMundialReel.tsx
...
const fadeIn = (frame, start, duration = 18) => (0,esm.interpolate)(frame, [start, start + duration], [0, 1], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp"
});
const slideUp = (frame, start, distance = 50, duration = 22) => (0,esm.interpolate)(frame, [start, start + duration], [distance, 0], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp"
});
const fadeOut = (frame, start, duration = 12) => (0,esm.interpolate)(frame, [start, start + duration], [1, 0], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp"
});
const SceneIntro = ({ frame, fps }) => {
  const opacity = fadeIn(frame, 8);
  const y = slideUp(frame, 8);
  const exit = frame > 72 ? fadeOut(frame, 72) : 1;
  const tagScale = (0,esm.spring)({ frame: frame - 5, fps, config: { damping: 14, stiffness: 140 } });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: s.brandBadge, children: "VOZ DO MUNDIAL" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "100%", opacity: 0.6 })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.introPre, children: "A tua opini\xE3o" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.introMain, children: "tamb\xE9m entra" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.introMain, children: "em campo." })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity, transform: `translateY(${y + 10}px)` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "200px" }) })
      ]
    }
  );
};
const SceneMatch = ({ frame, fps, teamA, teamB, competition, voteCountA, voteCountB }) => {
  const localFrame = frame - 90;
  const opacity = fadeIn(localFrame, 0);
  const exit = frame > 192 ? fadeOut(frame, 192) : 1;
  const scaleA = (0,esm.spring)({
    frame: localFrame - 5,
    fps,
    config: { damping: 16, stiffness: 120, mass: 0.9 }
  });
  const scaleB = (0,esm.spring)({
    frame: localFrame - 14,
    fps,
    config: { damping: 16, stiffness: 120, mass: 0.9 }
  });
  const vsOpacity = (0,esm.interpolate)(localFrame, [18, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const flagA = FLAGS[teamA] ?? FLAGS.Portugal;
  const flagB = FLAGS[teamB] ?? FLAGS.Espanha;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity, textAlign: "center", display: "flex", flexDirection: "column", gap: 12 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: s.competitionBadge, children: competition }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "180px", opacity: 0.5 })
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "row", gap: 24, width: "100%", opacity }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1, transform: `scale(${scaleA})`, opacity: scaleA }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            TeamCard,
            {
              name: teamA,
              flagStripes: flagA.stripes,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: s.vsBlock, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: s.vsText, children: "VS" }) })
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1, transform: `scale(${scaleB})`, opacity: scaleB }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            TeamCard,
            {
              name: teamB,
              flagStripes: flagB.stripes,
...
const SceneVotes = ({ frame, fps, teamA, teamB, question, voteCountA, voteCountB }) => {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.questionLabel, children: "A comunidade respondeu" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.questionMain, children: question }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "240px" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("p", { style: s.totalVotes, children: [
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: s.ctaLogo, children: "VOZ DO MUNDIAL" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "100%" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.ctaTagline, children: "Vota, compara e vibra" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.ctaTagline, children: "com a comunidade." })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldDivider, { width: "160px", opacity: 0.5 }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: s.ctaUrl, children: "vozdomundial.pt" })
            ]
          }
        )
      ]
...
const VozDoMundialReel = (props) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const { teamA, teamB, competition, question, voteCountA, voteCountB } = props;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(StadiumBackground, {}),
    frame < 90 && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneIntro, { frame, fps }),
    frame >= 78 && frame < 210 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      SceneMatch,
      {
        frame,
        fps,
    ...
    frame >= 198 && frame < 330 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      SceneVotes,
      {
        frame,
        fps,
    ...
    frame >= 318 && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneCTA, { frame, fps })
  ] });
};
const s = {
  brandBadge: {
...
const EASE = esm.Easing.bezier(0.16, 1, 0.3, 1);
const PulsingDot = () => {
  const frame = (0,esm.useCurrentFrame)();
  const entrance = (0,esm.interpolate)(frame, [0, 18], [0, 1], {
    easing: EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  const pulse = (0,esm.interpolate)(beatRaw, [-1, 1], [0.85, 1.18]);
  const flashScale = (0,esm.interpolate)(frame, [82, 94], [1, 80], {
    easing: EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const flashOpacity = (0,esm.interpolate)(frame, [86, 95], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
...
;// ./src/components/FlagParticles.tsx




const FlagParticles_EASE = esm.Easing.bezier(0.16, 1, 0.3, 1);
function sr(seed) {
...
const FlagParticles = () => {
  const frame = (0,esm.useCurrentFrame)();
  const particles = (0,react.useMemo)(buildParticles, []);
  const local = frame - 90;
  const bgOpacity = (0,esm.interpolate)(local, [0, 8], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      ...
      children: particles.map((p, i) => {
        ...
        const x = (0,esm.interpolate)(local, [animStart, animEnd], [0, p.tx], {
          easing: FlagParticles_EASE,
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
        const y = (0,esm.interpolate)(local, [animStart, animEnd], [0, p.ty], {
          easing: FlagParticles_EASE,
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
        const appeared = (0,esm.interpolate)(local, [animStart, animStart + 10], [0, p.opacity], {
          easing: FlagParticles_EASE,
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
        const dissolve = (0,esm.interpolate)(local, [90, 118], [1, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
...
// src/resolve-font-subsets.ts
var Inter_isChunkSubset = (subset) => /^\[\d+\]$/.test(subset);
var Inter_compareChunkSubsets = (a, b) => {
  return Number(a.slice(1, -1)) - Number(b.slice(1, -1));
};
var Inter_resolveFontSubsetKeys = ({
  availableSubsetKeys,
  metaSubsets,
  requestedSubset
}) => {
  ...
  const chunkSubsets = availableSubsetKeys.filter(Inter_isChunkSubset).sort(Inter_compareChunkSubsets);
  return chunkSubsets.length === 0 ? [requestedSubset] : chunkSubsets;
};
...
var Inter_loadFonts = (meta, style, options) => {
  ...
  for (const style2 of styles) {
    ...
    for (const weight of weights) {
      ...
      const availableSubsetKeys = Object.keys(meta.fonts[style2][weight]);
      const subsets = [
        ...new Set(requestedSubsets.flatMap((requestedSubset) => Inter_resolveFontSubsetKeys({
          availableSubsetKeys,
          metaSubsets: meta.subsets,
          requestedSubset
        })))
...
const { fontFamily: INTER } = Inter_loadFont();

;// ./src/components/UmaGeracaoLogo.tsx




const UmaGeracaoLogo_EASE = esm.Easing.bezier(0.16, 1, 0.3, 1);
const UmaGeracaoLogo = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const local = frame - 450;
  const bgOpacity = (0,esm.interpolate)(local, [0, 12], [0, 1], {
    easing: UmaGeracaoLogo_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  const logoOpacity = (0,esm.interpolate)(local, [4, 18], [0, 1], {
    easing: UmaGeracaoLogo_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const haloBeat = local % 28 / 28 * Math.PI * 2;
  const haloScale = (0,esm.interpolate)(Math.sin(haloBeat), [-1, 1], [1, 1.12]);
  const textOpacity = (0,esm.interpolate)(local, [22, 38], [0, 1], {
    easing: UmaGeracaoLogo_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const textY = (0,esm.interpolate)(local, [22, 38], [20, 0], {
    easing: UmaGeracaoLogo_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
...
;// ./src/compositions/UmaGeracaoReel.tsx
...
const UmaGeracaoReel_EASE = esm.Easing.bezier(0.16, 1, 0.3, 1);
function UmaGeracaoReel_fadeIn(frame, start, duration = 20) {
  return (0,esm.interpolate)(frame, [start, start + duration], [0, 1], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
}
function UmaGeracaoReel_fadeOut(frame, start, duration = 14) {
  return (0,esm.interpolate)(frame, [start, start + duration], [1, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
}
function slideFromRight(frame, start, duration = 24, distance = 120) {
  return (0,esm.interpolate)(frame, [start, start + duration], [distance, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
}
const SceneText = ({ frame }) => {
  const local = frame - 210;
  const bg = UmaGeracaoReel_fadeIn(local, 0, 16);
  const exit = frame > 312 ? UmaGeracaoReel_fadeOut(frame, 312) : 1;
  const l1Opacity = UmaGeracaoReel_fadeIn(local, 8, 22);
  const l1Y = (0,esm.interpolate)(local, [8, 30], [50, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const l2Opacity = UmaGeracaoReel_fadeIn(local, 36, 22);
  const l2Y = (0,esm.interpolate)(local, [36, 58], [50, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const lineOpacity = UmaGeracaoReel_fadeIn(local, 52, 16);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: l1Opacity, transform: `translateY(${l1Y}px)` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
            style: {
              fontFamily: BEBAS,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: l2Opacity, transform: `translateY(${l2Y}px)` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
            style: {
              fontFamily: BEBAS,
...
const SceneBlue = ({ frame }) => {
  const local = frame - 330;
  const bg = UmaGeracaoReel_fadeIn(local, 0, 20);
  const exit = frame > 432 ? UmaGeracaoReel_fadeOut(frame, 432) : 1;
  const t1Opacity = UmaGeracaoReel_fadeIn(local, 10, 22);
  const t1X = slideFromRight(local, 10, 26, 160);
  const t2Opacity = UmaGeracaoReel_fadeIn(local, 44, 22);
  const t2X = slideFromRight(local, 44, 26, 160);
  const divOpacity = UmaGeracaoReel_fadeIn(local, 36, 14);
  const divW = (0,esm.interpolate)(local, [36, 60], [0, 200], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
...
const SceneOutro = ({ frame }) => {
  const local = frame - 540;
  const lockOpacity = UmaGeracaoReel_fadeIn(local, 6, 18);
  const lockY = (0,esm.interpolate)(local, [6, 24], [30, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const handleOpacity = UmaGeracaoReel_fadeIn(local, 20, 18);
  const handleY = (0,esm.interpolate)(local, [20, 38], [20, 0], {
    easing: UmaGeracaoReel_EASE,
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const finalFade = (0,esm.interpolate)(local, [46, 58], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
...
const UmaGeracaoReel = () => {
  const frame = (0,esm.useCurrentFrame)();
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#000000" }, children: [
    frame < 96 && /* @__PURE__ */ (0,jsx_runtime.jsx)(PulsingDot, {}),
    frame >= 86 && frame < 210 && /* @__PURE__ */ (0,jsx_runtime.jsx)(FlagParticles, {}),
    frame >= 200 && frame < 330 && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneText, { frame }),
    frame >= 320 && frame < 450 && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneBlue, { frame }),
    frame >= 440 && frame < 540 && /* @__PURE__ */ (0,jsx_runtime.jsx)(UmaGeracaoLogo, {}),
    frame >= 530 && /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneOutro, { frame })
  ] });
};
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        ...
        defaultProps: {
          teamA: "Portugal",
          teamB: "Espanha",
          competition: "Mundial 2026 \xB7 Fase de Grupos",
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(750), __webpack_require__.e(961), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 2961)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "mundial-voto-vibra-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmundial_voto_vibra_remotion"] = self["webpackChunkmundial_voto_vibra_remotion"] || [];
