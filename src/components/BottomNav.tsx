...
/**
 * Os cinco destinos da semana.
 *
 * Não é a lista de páginas — é o que se faz. Vota-se (Jogos), vê-se
 * onde se está (Rankings), compara-se com quem se conhece (Torneios),
 * e a Home é o resumo de tudo.
 *
 * A Classificação e os Duelos não estão aqui porque já são separadores
 * dentro dos Jogos e dos Torneios: estariam a um toque de qualquer
 * maneira, e cada entrada a mais rouba largura às outras. O que só
 * existe no menu do logótipo é o DNA.
 */
const NAV_ITEMS = [
