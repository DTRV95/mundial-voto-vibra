...
export function nomeCurto(nome: string): string {
  const conhecidos: [RegExp, string][] = [
    ...
    // Europa. Sem isto, "Manchester City FC" ficava "Manches…" no
    // cabeçalho do jogo — que é onde o nome tem de se ler de relance.
    [/manchester city/i, "Man. City"],
    [/manchester united/i, "Man. United"],
    [/internazionale|inter milan/i, "Inter"],
    [/atl[ée]tico de madrid|atl[ée]tico madrid/i, "Atlético"],
    [/real madrid/i, "Real Madrid"],
    [/real betis/i, "Betis"],
    [/real sociedad/i, "Real Sociedad"],
    [/bayern m/i, "Bayern"],
    [/borussia dortmund/i, "Dortmund"],
    [/borussia m/i, "M'gladbach"],
    [/paris saint-germain|paris sg/i, "PSG"],
    [/bayer 04|bayer leverkusen/i, "Leverkusen"],
    [/rb leipzig|rasenballsport/i, "Leipzig"],
    [/club brugge/i, "Brugge"],
    [/club atl[ée]tico/i, "Atlético"],
    [/aston villa/i, "Aston Villa"],
    [/tottenham/i, "Tottenham"],
    [/shakhtar/i, "Shakhtar"],
    [/slovan bratislava/i, "Slovan"],
    [/bod[oø].?glimt/i, "Bodø/Glimt"],
    [/olympiacos|olympiakos/i, "Olympiacos"],
    [/\bpae aek\b|\baek\b/i, "AEK"],
    [/lask/i, "LASK"],
    [/slavia praha/i, "Slavia"],
    [/sparta praha/i, "Sparta"],
    [/racing club de lens|\brc lens\b/i, "Lens"],
    [/fenerbah/i, "Fenerbahçe"],
    [/galatasaray/i, "Galatasaray"],
    [/feyenoord/i, "Feyenoord"],
    [/vfb stuttgart/i, "Stuttgart"],
    [/como 1907/i, "Como"],
    [/villarreal/i, "Villarreal"],
    [/\bas roma\b/i, "Roma"],
    [/ssc napoli|\bnapoli\b/i, "Nápoles"],
    [/lille osc/i, "Lille"],
    [/viking fk/i, "Viking"],
    [/sabah fk/i, "Sabah"],
  ];
