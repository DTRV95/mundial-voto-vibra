...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Ultima Geração" },
      ...
      { name: "keywords", content: "Mundial 2026, previsões Mundial, palpites futebol, comunidade futebol, jogos do Mundial, ranking Mundial, Ultima Geração, ScoreLab" },
      { name: "robots", content: "index, follow" },
      { property: "og:site_name", content: "Ultima Geração" },
      { property: "og:title", content: "Ultima Geração — Vota, compara e vibra com a comunidade" },
      ...
      { name: "twitter:title", content: "Ultima Geração — Mundial 2026" },
