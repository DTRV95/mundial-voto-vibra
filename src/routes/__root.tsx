...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Mundial, previsões Mundial, palpites Mundial, comunidade Mundial, jogos do Mundial, ranking Mundial, previsões futebol, Voz do Mundial" },
      { property: "og:title", content: "Voz do Mundial" },
