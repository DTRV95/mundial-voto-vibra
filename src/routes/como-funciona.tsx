      ...
      <Section icon={RotateCcw} title="Reset de Pontos por Fase">
        ...
        <div className="space-y-2">
          {[
            ...
            { phase: "16 Avos de Final", status: "🔥 A decorrer", desc: "Pontos reiniciados — nova corrida!" },
            { phase: "Oitavos de Final", status: "⏳ A seguir", desc: "" },
            { phase: "Quartos / Meias / Final", status: "⏳ Em breve", desc: "" },
